    ...
    <aside className="sidebar-profile">
      ...
      <nav className="sidebar-profile-links">
        ...
        <a href="https://researchmap.jp/s_minegishi">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M3 2a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h18a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H3zm3 4h12v2H6V6zm0 4h12v2H6v-2zm0 4h8v2H6v-2z"/></svg>
